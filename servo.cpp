...
int main(int argc, char **argv)
{
    ...
    // cout << "group_no: "<< group_number << endl;
    ...
    motion_init();
    usleep(1000000); // must wait 1s, to finish standing
    cout << lowState.motorState[11].q << endl;

    // Execute the trajectory
    
    loadTrajectoryFromFile("/home/ubuntu/Downloads/Trajectories/T/trajectoryLeap1T.csv", torques, Tdurations);
    loadTrajectoryVel("/home/ubuntu/Downloads/Trajectories/dq/trajectoryLeap1dq.csv", trajectories, velocities, durations);
    cout << durations[0] << endl;
    cout << trajectories[0][2] << endl;
    cout << velocities[0][2] << endl;
    cout << torques[0][2] << endl;
    std::cout << "Robot is in standing position and trajectory loaded. Press Enter to start the trajectory motion..." << std::endl;
    
    std::cin.get();
    cout << "Executing..." << endl;
    //moveAllPositionMult(trajectories, Tdurations);
    //moveAllPosVel(trajectories, velocities, Tdurations);
    moveAllPosVelInt(trajectories, velocities, Tdurations);
    //moveAllTorque(torques, Tdurations);

    cout << "Executed" << endl;
    usleep(300000);
    cout << lowState.motorState[11].q << endl;
    cout << lowState.motorState[10].q << endl;
    cout << lowState.motorState[9].q << endl;
